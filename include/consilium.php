<section class="section info section-3 overflow-hidden">
    <div class="container">
        <div class="flex items-center justify-between gap-3 mb-11 info-wrapper">
            <div>
                <p class="info__title wow fadeInUp wow fadeInUp">Запишитесь на консультацию</p>
        ...
        <div class="info__video-wrapper relative">
            <img class="info-video-btn" src="<?php echo get_template_directory_uri() ?>/src/video/play.svg" alt="">
            <video preload="metadata" muted controls
            poster="<?php echo get_template_directory_uri() ?>/src/img/info.webp"
            class="video info__video">
            <source src="<?php echo get_template_directory_uri() ?>/src/video/main-video-3.mp4" type="video/mp4">
        </video>    
    </div>
    </div>
</section>